...
const taglines = [
  "BookHub: Smart Library for Smart Classrooms",
  "Fueling Young Minds with Smarter Access to Books at BookHub",
  "Where Every Book at BookHub Finds Its Reader",
  "BookHub: The AI Library Experience for Your School",
];
...
const features = [
  {
    ...
    description:
      "BookHub intelligently organizes and discovers books using advanced AI algorithms, making your search easy and effective.",
  },
  {
    icon: Search,
    title: "Smart Search",
    description:
      "Find any book in BookHub instantly, thanks to our cutting-edge search and recommendation engine.",
  },
  {
    icon: BarChart3,
    title: "Usage Analytics",
    description:
      "See what's popular and how the BookHub collection is being enjoyed across the school.",
  },
  {
    icon: Users,
    title: "Student-Friendly Experience",
    description:
      "BookHub's interface ensures that exploring, borrowing, and enjoying books is seamless for every student.",
  },
];
    ...
    >
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            Welcome to BookHub — Your Smart School Library
          </motion.h1>
          ...
          >
            BookHub is your school's very own intelligent library, designed to
          ...
          >
            ...
            student-friendly interfaces, BookHub helps educators and librarians
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-gray-900 via-blue-600 to-blue-800 dark:from-white dark:via-blue-100 dark:to-purple-200 bg-clip-text text-transparent">
              Why BookHub Is the Ultimate School Library
            </h2>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
              At BookHub, our mission is to foster curiosity, creativity, and
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400">
            © 2025 BookHub. Transforming library, inspiring minds.
          </p>
        </div>
      </motion.footer>
    </div>

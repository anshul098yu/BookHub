        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              >
                <BookOpen className="text-customblue" /> <span>BookHub</span>
              </h3>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-3">
                {[
                  {
                    icon: Linkedin,
                    href: "https://www.linkedin.com/in/anshul-raj-4129b625a/",
                    label: "LinkedIn",
                  },
                  {
                    icon: Github,
                    href: "https://github.com/anshul098yu",
                    label: "GitHub",
                  },
                  {
                    icon: Twitter,
                    href: "https://x.com/anshulraj09876",
                    label: "Twitter"
                  },
                  {
                    icon: Instagram,
      ...
      <div className="px-4 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-sm text-zinc-700 dark:text-zinc-400">
            © 2025 BookHub Library. All rights reserved.
          </div>

  ...
  return (
    <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-3 mt-6">
      <AnalyticsCard
        ...
        color="blue"
        percentageChange={analyticsStats?.booksPercentIncrease ? analyticsStats.booksPercentIncrease.toFixed(1) : null}
        showTrend={true}
      />
      <AnalyticsCard
        icon={Users}
        ...
        color="cyan"
        percentageChange={analyticsStats?.usersPercentIncrease ? analyticsStats.usersPercentIncrease.toFixed(1) : null}
        showTrend={true}
      />
      <AnalyticsCard
        icon={NotebookPen}

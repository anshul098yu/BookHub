...
app.use(
  cors({
    origin: [process.env.CLIENT_URL, "http://localhost:5173", "http://localhost:5174", "http://localhost:5175", "https://book-hub-zeta-blue.vercel.app" ," https://book-kjc538idh-anshul098yus-projects.vercel.app "],
    credentials: true,
